...
def Global_Local_animate(midline,L1,L2,theta,global_head_phi,Radius,Observed_distance,Observed_phi,Observed_index,Observed_head_phi,vid,R,DATA_circle,bool_have_wall=True,Observer_index=0,t_start=0,Frame_interval=100):
    ...
    def animate(i):
        ...
        circle = plt.Circle((midline[i,Observer_index,1,0], midline[i,Observer_index,1,1]), R, color='black', fill=False)
